...
const SAMPLE_ECONOMIC_EVENTS: EconomicEvent[] = [
  {
    ...
    title: 'FOMC Federal Funds Interest Rate Decision & Powell Speech',
    country: 'US',
    ...
    description: 'Federal Reserve rate cut probability at 88%. Massive implied volatility on Gold (XAU/USD), EUR/USD, and S&P 500.',
  },
  {
    id: 'us-cpi-inflation',
    title: 'US Consumer Price Index (CPI YoY Headline & Core)',
    country: 'US',
    category: 'inflation',
    impact: 'HIGH',
    ...
    forecast: '2.6%',
    volatilityRisk: 'EXTREME',
    description: 'Core inflation release determining Fed easing trajectory. Critical for Gold ($XAU) and US Dollar Index ($DXY).',
  },
  {
    id: 'ecb-rate-decision',
    title: 'ECB Main Refinancing Rate Decision & Press Conference',
    country: 'EU',
    category: 'central_bank',
    impact: 'HIGH',
    date: '2026-08-30 12:15 UTC',
    timestamp: Date.now() + 1000 * 60 * 60 * 130,
    timeUntil: 'in 5 days',
    previous: '3.75%',
    forecast: '3.50% (-25 bps cut)',
    volatilityRisk: 'HIGH',
    description: 'European Central Bank monetary policy meeting. Direct high-velocity impact on EUR/USD and EUR/GBP.',
  },
  {
    id: 'opec-oil-meeting',
    title: 'OPEC+ Crude Oil Production Quota & Strategy Meeting',
    country: 'GLOBAL',
    category: 'commodity',
    impact: 'HIGH',
    ...
    timeUntil: 'in 8 days',
    previous: '2.2M bpd voluntary cuts',
    forecast: 'Gradual phase-out debate',
    volatilityRisk: 'EXTREME',
    description: 'Global crude oil supply benchmark. Direct impact on WTI Crude ($WTI) and Brent Oil ($BRENT).',
  },
  {
    id: 'us-nonfarm-payrolls',
    title: 'US Non-Farm Payrolls & Unemployment Rate (NFP)',
    country: 'US',
    category: 'employment',
    impact: 'HIGH',
    ...
    forecast: '160K / 4.1%',
    volatilityRisk: 'EXTREME',
    description: 'US labor market health benchmark affecting macro dollar index (DXY), Gold Spot, and Forex pairs.',
  },
  {
    id: 'rbi-repo-rate',
    ...
    category: 'central_bank',
    impact: 'HIGH',
    date: '2026-09-06 04:30 UTC',
    timestamp: Date.now() + 1000 * 60 * 60 * 290,
    timeUntil: 'in 12 days',
    previous: '6.50%',
    forecast: '6.50% (Status Quo)',
    volatilityRisk: 'ELEVATED',
    description: 'Reserve Bank of India interest rate stance. Direct impact on USD/INR exchange rate and NIFTY 50 index.',
  },
  {
